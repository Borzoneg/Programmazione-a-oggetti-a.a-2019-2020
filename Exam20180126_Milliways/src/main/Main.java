...
public class Main {
	...
	public static void main(String[] args) throws MilliwaysException {
		...
		System.out.println(main_hall.isSuitable(party1) + ", is suitable");
		...
		for(Race r : milliways.statComposition().keySet())
		    System.out.println(r.getName() + " " + milliways.statComposition().get(r));
		System.out.println("asd");
